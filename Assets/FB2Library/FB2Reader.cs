...
namespace FB2Library
{
	...
	public class FB2Reader : IFB2Reader
	{
		...
		/// <returns></returns>
		public async Task<FB2File> ReadAsync(Stream stream, XmlLoadSettings settings)
		{
			if (settings == null)
		...
		/// <returns></returns>
		public async Task<FB2File> ReadAsync(string xml)
		{
			return await Task.Factory.StartNew(() =>
			{
				var file = new FB2File();
        ...
        internal Task<FB2File> ReadAsync(object xml)
        {
